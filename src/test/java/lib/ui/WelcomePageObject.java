...
public class WelcomePageObject extends MainPageObject {
    ...
    STEP_LEARN_MORE_WIKIPEDIA = "id:Learn more about Wikipedia",
    ...
    public void waitForLearnMoreLink(){
        this.waitForElementPresent(STEP_LEARN_MORE_WIKIPEDIA, "Cannot find 'Learn more about Wikipedia' link.", 10);
    }
